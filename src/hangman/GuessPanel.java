...
public class GuessPanel {
    ...
    private void createPartControl() {
        ...
        BackActionListener listener2 = new BackActionListener();
        
        btnBack = new JButton("CLOSE");
        btnBack.addActionListener(listener2);
        
        btnBack.registerKeyboardAction(btnBack
                .getActionForKeyStroke(KeyStroke.getKeyStroke(
                        KeyEvent.VK_SPACE, 0, false)), KeyStroke.getKeyStroke(
                KeyEvent.VK_BACK_SPACE, 0, false), JButton.WHEN_IN_FOCUSED_WINDOW);
        btnBack.registerKeyboardAction(btnBack
                .getActionForKeyStroke(KeyStroke.getKeyStroke(
                        KeyEvent.VK_SPACE, 0, true)), KeyStroke.getKeyStroke(
                KeyEvent.VK_BACK_SPACE, 0, true), JButton.WHEN_IN_FOCUSED_WINDOW);
        guessPanel.add(btnBack);
    }
